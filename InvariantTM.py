...
def main():
    ...
    template_bgr = plt.imread('./images.jpg')
    ...
    # plt.show()
    points_list = invariantMatchTemplate(img_rgb, cropped_template_rgb, "TM_CCOEFF_NORMED", 0.5, 500, [0,10], 10, [10,200], 10, True, True)
